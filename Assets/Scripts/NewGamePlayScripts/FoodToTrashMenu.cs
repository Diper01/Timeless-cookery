...
public class FoodToTrashMenu : MonoBehaviour
{
    ...
    public void _AdRewarded()
    {
        ...
        //    missionManager.foodToTrashCount = 0;
    ...
    public void _OkButton()
    {
        ...
        else if (playerStats.crystal < 15)
        {
            ...
            gamePlayMenuManager.notEnoughCrystalMenu.GetComponent<GameplayNotEnoughCrystalMenu>().gpMenuType = GameplayNotEnoughCrystalMenu.GP_MENU_TYPE.TRASH_FOOD;
            gameObject.SetActive(false);
        }
    }
    ...
    public void _CloseButton()
    {
        ...
        missionManager.foodToTrashClosed = true;
