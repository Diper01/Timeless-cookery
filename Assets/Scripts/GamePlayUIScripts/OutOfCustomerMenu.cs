...
public class OutOfCustomerMenu : MonoBehaviour
{
    ...
    public void _AdRewarded()
    {
        ...
        //    customerManager.customerCount -= 3;
        //    missionManager.customerCount -= 3;
        //    missionManager.customerLeft = customerManager.customerLimit - customerManager.customerCount;
    ...
    public void _OkButton()
    {
        ...
        else if(playerStats.crystal < 15)
        {
            ...
            gamePlayMenuManager.notEnoughCrystalMenu.GetComponent<GameplayNotEnoughCrystalMenu>().gpMenuType = GameplayNotEnoughCrystalMenu.GP_MENU_TYPE.OUT_CUS;
            gameObject.SetActive(false);
        }
    }
