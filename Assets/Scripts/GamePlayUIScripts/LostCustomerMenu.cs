...
public class LostCustomerMenu : MonoBehaviour
{
    ...
    public void _AdRewarded()
    {
        ...
        //    missionManager.customerAngryCount = 0;

        //    Debug.Log("Da phuc hoi nhiem vu Lost Customer " + missionManager.customerAngryCount);
    ...
    public void _OkButton()
    {
        ...
        else if (playerStats.crystal < 15)
        {
            ...
            gamePlayMenuManager.notEnoughCrystalMenu.GetComponent<GameplayNotEnoughCrystalMenu>().gpMenuType = GameplayNotEnoughCrystalMenu.GP_MENU_TYPE.LOST_CUS;
            gameObject.SetActive(false);
        }
    }
    ...
    public void _CloseButton()
    {
        ...
        missionManager.lostCustomerClosed = true;
